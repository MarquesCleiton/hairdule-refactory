...
| **08** | [CHECKLIST_FASE_08.md](./CHECKLIST_FASE_08.md) | Angular 19 — Auth UI Login/Signup/Reset (porta 4300) | `fase_08_hairdule_ui_auth` | ⬜ 0% (Próxima) |

### 🌟 MARCO 2 — Onboarding & Barbearia (Fases 09-10)
| Fase | Arquivo | Tecnologia | Repositório | Status |
|---|---|---|---|---|
| **09** | [CHECKLIST_FASE_09.md](./CHECKLIST_FASE_09.md) | Lambda Python 3.12 — Barbershop + Onboarding (3002) | `fase_09_hairdule_barbershop_service` | ⬜ 0% |
| **10** | [CHECKLIST_FASE_10.md](./CHECKLIST_FASE_10.md) | Angular — Wizard Onboarding 5 Etapas | `fase_10_hairdule_ui_onboarding` | ⬜ 0% |
...
| **12** | [CHECKLIST_FASE_12.md](./CHECKLIST_FASE_12.md) | Angular — Gestão de Profissionais | `fase_12_hairdule_ui_staff` | ⬜ 0% |
| **13** | [CHECKLIST_FASE_13.md](./CHECKLIST_FASE_13.md) | Lambda Python — Services CRUD + Preços (3004) | `fase_13_hairdule_service_service` | ⬜ 0% |
| **14** | [CHECKLIST_FASE_14.md](./CHECKLIST_FASE_14.md) | Angular — Catálogo Drag-and-Drop | `fase_14_hairdule_ui_services` | ⬜ 0% |
...
| **16** | [CHECKLIST_FASE_16.md](./CHECKLIST_FASE_16.md) | Angular — Configuração de Horários e Bloqueios | `fase_16_hairdule_ui_availability` | ⬜ 0% |
...
| **18** | [CHECKLIST_FASE_18.md](./CHECKLIST_FASE_18.md) | Angular — Calendário Interativo | `fase_18_hairdule_ui_calendar` | ⬜ 0% |
...
| Fase | Arquivo | Tecnologia | Repositório | Status |
|---|---|---|---|---|
| **20** | [CHECKLIST_FASE_20.md](./CHECKLIST_FASE_20.md) | SST v4 + S3 + CloudFront CDN | `fase_20_hairdule_infra_cdn` | ⬜ 0% |
...
| **23** | [CHECKLIST_FASE_23.md](./CHECKLIST_FASE_23.md) | Angular — Planos e Faturamento | `fase_23_hairdule_ui_billing` | ⬜ 0% |
...
| **25** | [CHECKLIST_FASE_25.md](./CHECKLIST_FASE_25.md) | Angular — Central de Notificações | `fase_25_hairdule_ui_notifications` | ⬜ 0% |
...
| Marco 1 — Autenticação E2E (Fases 06-08) | ~120 | ~35 | **~29%** |
...
7. **[ ] Iniciar Fase 07 (`fase_07_hairdule_infra_api`)** — Provisionamento do API Gateway v2 HTTP API + WAF
8. **[ ] Iniciar Fase 08 (`fase_08_hairdule_ui_auth`)** — Frontend Angular 19 de Autenticação (Login/Signup/Reset)
